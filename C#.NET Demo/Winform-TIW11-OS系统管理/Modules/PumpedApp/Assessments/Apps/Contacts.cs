...
namespace ThisIsWin11.PumpedApp.Assessment.Apps
{
    internal class Contacts : AssessmentBase
    {
        ...
        private const string keyName = @"HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\contacts";
        ...
        public override bool UndoAssessment()
        {
            try
            {
                ...
                logger.Log("- App access to contacts has been successfully enabled.");
                return true;
            }
            catch
            { }
