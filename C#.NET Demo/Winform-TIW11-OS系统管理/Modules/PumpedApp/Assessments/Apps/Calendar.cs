...
namespace ThisIsWin11.PumpedApp.Assessment.Apps
{
    internal class Calendar : AssessmentBase
    {
        ...
        private const string keyName = @"HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\appointments";
        ...
        public override bool UndoAssessment()
        {
            try
            {
                ...
                logger.Log("- App access to calendar has been successfully enabled.");
                return true;
            }
            catch
            { }
