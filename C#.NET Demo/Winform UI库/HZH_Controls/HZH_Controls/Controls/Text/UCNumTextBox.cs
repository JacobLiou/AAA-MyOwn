...
namespace HZH_Controls.Controls
{
    ...
    public partial class UCNumTextBox : UserControl
    {
        ...
        public decimal Num
        {
            ...
            set {
                if(value < txtNum.MinValue)
                    txtNum.Text = txtNum.MinValue.ToString();
                else if(value > txtNum.MaxValue)
                    txtNum.Text = txtNum.MaxValue.ToString();
                else
        ...
        private void UCNumTextBox_Load(object sender, EventArgs e)
        {
            if(this.BackColor == Color.Transparent)
                this.txtNum.BackColor = Color.White;
            else
