...
namespace HZH_Controls.Controls
{
    ...
    public class UCTrackBar : Control
    {
        ...
        [Description("值改变完毕事件"), Category("自定义")]
        public event EventHandler ValueChangedDone;
        ...
        public float Value
        {
            ...
            set
            {
                ...
                if(value < minValue)
                    ...
                    val = value;
                var v = (float)Math.Round((double)val, dcimalDigits);
                if (m_value == v)
                    return;
                this.m_value = v;
                this.Refresh();
        ...
        {
            blnDown = false;
            if(Value != blnDownValue && ValueChangedDone != null)
            {
                ValueChangedDone(this, null);
            }
