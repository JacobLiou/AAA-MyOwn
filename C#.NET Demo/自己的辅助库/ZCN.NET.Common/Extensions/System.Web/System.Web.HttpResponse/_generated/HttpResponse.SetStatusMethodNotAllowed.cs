...
namespace ZCN.NET.Common.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        {
            @this.StatusCode = 405;
            //@this.StatusDescription = "Method Not Allowed 请求方法（GET、POST、HEAD、DELETE、PUT、TRACE等）对指定的资源不适用，用来访问本页面的 HTTP 谓词不被允许（方法不被允许）";
        }
    }
}
...
namespace ZCN.NET.Common.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        {
            @this.StatusCode = 405;
            @this.StatusDescription = "Method Not Allowed 请求方法（GET、POST、HEAD、DELETE、PUT、TRACE等）对指定的资源不适用，" +
                                      "用来访问本页面的 HTTP 谓词不被允许（方法不被允许）";
        }
    }
}
