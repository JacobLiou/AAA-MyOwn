...
namespace ZCN.NET.Common.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        public static string ToDigitBit2String(this int value)
        {
            try
            {
        ...
        public static string ToDigitBit8String(this int value)
        {
            try
            {
        ...
        public static string ToDigitBit10String(this int value)
        {
            try
            {
        ...
        public static string ToDigitBit16String(this int value)
        {
            try
            {
