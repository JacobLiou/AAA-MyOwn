...
namespace ZCN.NET.CommonX.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        /// <returns>一个等于 value 的 64位有符号整数</returns>
        public static long ToLong(this object value, Func<long> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return 0;
        ...
        /// </param> 
        /// <returns>一个等于 value 的 64位有符号整数</returns>
        public static long? ToLongNullable(this object value, IFormatProvider provider)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValue">转换失败时返回的默认值</param>
        /// <returns>一个等于 value 的 64位有符号整数</returns>
        public static long? ToLongNullable(this object value, long defaultValue)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValueFactory">转换失败时返回的默认值(产生默认值的方法)</param>
        /// <returns>一个等于 value 的 64位有符号整数</returns>
        public static long? ToLongNullable(this object value, Func<long> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValueFactory">转换失败时返回的默认值(产生默认值的方法)</param>
        /// <returns>一个等于 value 的 64位无符号整数</returns>
        public static ulong ToULong(this object value, Func<ulong> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return 0;
        ...
        /// <param name="value">扩展对象</param>
        /// <returns>一个等于 value 的 64位无符号整数</returns>
        public static ulong? ToULongNullable(this object value)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// </param> 
        /// <returns>一个等于 value 的 64位无符号整数</returns>
        public static ulong? ToULongNullable(this object value, IFormatProvider provider)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValue">转换失败时返回的默认值</param>
        /// <returns>一个等于 value 的 64位无符号整数</returns>
        public static ulong? ToULongNullable(this object value, ulong defaultValue)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValueFactory">转换失败时返回的默认值(产生默认值的方法)</param>
        /// <returns>一个等于 value 的 64位无符号整数</returns>
        public static ulong? ToULongNullable(this object value, Func<ulong> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return null;
