...
namespace ZCN.NET.CommonX.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        /// <returns>与 value 等效的单精度浮点数，如果 value 为 null，则为 0（零）</returns>
        public static float ToFloat(this object value, Func<float> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return 0;
        ...
        public static float? ToToFloatNullable(this object value)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// </param> 
        /// <returns>与 value 等效的单精度浮点数 或 null</returns>
        public static float? ToToFloatNullable(this object value, IFormatProvider provider)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValue">转换失败时返回的默认值</param>
        /// <returns>与 value 等效的单精度浮点数 或 null</returns>
        public static float? ToToFloatNullable(this object value, float? defaultValue)
        {
            if (value.IsDBNullOrNull())
                return null;
        ...
        /// <param name="defaultValueFactory">转换失败时返回的默认值(产生默认值的方法)</param>
        /// <returns>与 value 等效的单精度浮点数 或 null</returns>
        public static float? ToToFloatNullable(this object value, Func<float?> defaultValueFactory)
        {
            if (value.IsDBNullOrNull())
                return null;
