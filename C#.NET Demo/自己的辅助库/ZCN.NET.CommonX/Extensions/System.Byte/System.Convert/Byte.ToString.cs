...
namespace ZCN.NET.CommonX.Extensions
{
    public static partial class CommonExtensions
    {
        ...
        public static string ToDigitBit2String(this byte value)
        {
            try
            {
        ...
        public static string ToDigitBit8String(this byte value)
        {
            try
            {
        ...
        public static string ToDigitBit10String(this byte value)
        {
            try
            {
        ...
        public static string ToDigitBit16String(this byte value)
        {
            try
            {
