...
namespace ZCN.NET.Common.Component
{
    ...
    {
        private const string NAME = "_ZCN.NET";

        private static T _instance = CallContext.GetData(typeof(T).Name + NAME) as T;
            ...
            get
            {
                ...
                if (_instance == null)
                {
                    lock (_lock)
                    {
                        ...
                        {
                            _instance = new T();
                            CallContext.SetData(typeof(T).Name + NAME, _instance);
                        }
                    }
                }
                return _instance;
