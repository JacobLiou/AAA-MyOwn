    ...
    public sealed class HttpManager
    {
        ...
        private HttpResult RequestString(string url, string data, string method, string contentType)
        {
            ...
            ServicePointManager.SecurityProtocol = SecurityProtocolType.Ssl3
                                                 ...
                                                 | SecurityProtocolType.Tls12; // 配置ServicePointManager， 解决 HttpWebRequest 访问 https 请求被中止: 未能创建 SSL/TLS 安全通道
            ...
            try
            {
                ...
                httpWebRequest.ContentLength = 0; //如果没有请求体，则内容长度为0
        ...
        private void GetWebExceptionResponse(ref HttpResult httpResult, WebException webException)
        {
            ...
            if (exResponse != null)
            {
                ...
                {
                    httpResult.Text = httpResult.RefText = sr.ReadToEnd();
                }
        ...
        public static string GetUserAgent()
        {
            ...
            return string.Format("{0}/{1} ({2}; {3})", ZCN_NET_SDK.ALIAS, ZCN_NET_SDK.VERSION, ZCN_NET_SDK.RTFX, osDesc);
        }
        ...
        public static string CreateFormDataBoundary()
        {
            ...
            return string.Format("----{0}_Boundary_{1}", ZCN_NET_SDK.ALIAS, now.EncryptByMD5());
        }
